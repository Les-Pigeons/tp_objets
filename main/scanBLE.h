...
gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param) {
    ...
    switch (event) {
        ...
        case ESP_GATTC_SEARCH_RES_EVT: {
            ESP_LOGI(GATTC_TAG, "SEARCH RES: conn_id = %x is primary service %d", p_data->search_res.conn_id,
            ...
            if (p_data->search_res.srvc_id.uuid.len == ESP_UUID_LEN_16 &&
                ...
                get_server = true;
                gl_profile_tabc[PROFILE_A_APP_ID].service_start_handle = p_data->search_res.start_handle;
                gl_profile_tabc[PROFILE_A_APP_ID].service_end_handle = p_data->search_res.end_handle;
        ...
        case ESP_GATTC_SEARCH_CMPL_EVT:
            ...
            if (get_server) {
                ...
                esp_gatt_status_t status = esp_ble_gattc_get_attr_count(gattc_if,
                                                                        ...
                                                                        gl_profile_tabc[PROFILE_A_APP_ID].service_start_handle,
                                                                        gl_profile_tabc[PROFILE_A_APP_ID].service_end_handle,
                                                                        INVALID_HANDLE,
                                                                        &count);
                ...
                if (count > 0) {
                    ...
                    if (!char_elem_result) {
                        ...
                        if (count > 0 && (char_elem_result[0].properties & ESP_GATT_CHAR_PROP_BIT_NOTIFY)) {
                            gl_profile_tabc[PROFILE_A_APP_ID].char_handle = char_elem_result[0].char_handle;
                            esp_ble_gattc_register_for_notify(gattc_if, gl_profile_tabc[PROFILE_A_APP_ID].remote_bda,
        ...
        case ESP_GATTC_REG_FOR_NOTIFY_EVT: {
            ...
            if (p_data->reg_for_notify.status != ESP_GATT_OK) {
                ...
                esp_gatt_status_t ret_status = esp_ble_gattc_get_attr_count(gattc_if,
                                                                            gl_profile_tabc[PROFILE_A_APP_ID].conn_id,
                                                                            ESP_GATT_DB_DESCRIPTOR,
                                                                            gl_profile_tabc[PROFILE_A_APP_ID].service_start_handle,
                                                                            gl_profile_tabc[PROFILE_A_APP_ID].service_end_handle,
                                                                            gl_profile_tabc[PROFILE_A_APP_ID].char_handle,
                                                                            &count);
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param) {
    ...
    switch (event) {
        ...
        case ESP_GAP_BLE_SCAN_START_COMPLETE_EVT:
            ...
            ESP_LOGW("SELF_SCAN", "scan start success");
        ...
        case ESP_GAP_BLE_SCAN_RESULT_EVT: {
            ...
            switch (scan_result->scan_rst.search_evt) {
                case ESP_GAP_SEARCH_INQ_RES_EVT:
                    ESP_LOGW("SELF_SCAN", "Scanned, %d", adv_name_len);
...
static void esp_gattc_cb(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param) {
    ESP_LOGW("SELF_SCAN", "Gatt event type is %d", event);
...
void init_SCAN() {
    ...
    ESP_LOGW("SELF_SCAN", "Enabling bluetooth");
